    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлено в обработку'), ('PRD', 'обработано'), ('PD', 'оплачено'), ('RDY', 'готов к выдаче'), ('CNC', 'отменено')], default='FM', max_length=3, verbose_name='статус')),
